...
#first attribute was a factor (0,1) and has been transformed to be numeric for consistency with all
#of the other numeric attributes. Also note that the second attribute is a constant and has been 
#removed.
